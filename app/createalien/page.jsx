    ...
    <main>
      <div className="modal">
        <div className="text-box">
          ...
          <div className="aliencard border winner-card" id="capture">
            {' '}
            {/* This div is the one to download */}
            <img
            ...
            <img
              ...
              id="alien-mouth"
              src={`assets/alien-layers/mouth-${alien.isFriendly[isFriendlyIndex]}.png`}
            />
            {alien.horns[hornsIndex] ? (
              <img
                className="alien-horns"
                id="alien-horns"
                src={`assets/alien-layers/horns-${alien.horns[hornsIndex]}.png`}
              />
            ) : null}
            {alien.hasAntenna[antennaIndex] ? (
              <img
            ...
            <div className="alien-name-holder" id="alien-name-holder">
              <div className="alien-name" id="alien-name">
                {name}
              </div>
            </div>
          </div>
          ...
          <div className="statsContainer">
            ...
            <button
              className="question-submit-btn"
              disabled={planetIndex === alien.planet.length - 1}
              onClick={() => {
                attributeSetter('planet', +1);
              }}
            >
            ...
            <button
              className="question-submit-btn"
              disabled={skinTextureIndex === 0}
              onClick={() => {
                attributeSetter('skinTexture', -1);
              }}
            >
              {'<<'}
            </button>
            <button
              className="question-submit-btn"
              onClick={() => {
                attributeRandomizer('skinTexture');
              }}
            >
              Random
            </button>
            <button
              className="question-submit-btn"
              disabled={skinTextureIndex === alien.skinTexture.length - 1}
              onClick={() => {
                attributeSetter('skinTexture', +1);
              }}
            >
            ...
            <button
              className="question-submit-btn"
              disabled={skinColourIndex === 0}
              onClick={() => {
                attributeSetter('skinColour', -1);
              }}
            >
              {'<<'}
            </button>
            <button
              className="question-submit-btn"
              onClick={() => {
                attributeRandomizer('skinColour');
              }}
            >
              Random
            </button>
            <button
              className="question-submit-btn"
              disabled={skinColourIndex === alien.skinColour.length - 1}
              onClick={() => {
                attributeSetter('skinColour', +1);
              }}
            >
            ...
            <button
              className="question-submit-btn"
              disabled={eyesIndex === alien.eyes.length - 1}
              onClick={() => {
                attributeSetter('eyes', +1);
              }}
            >
            ...
            <button
              className="question-submit-btn"
              disabled={eyeColourIndex === 0}
              onClick={() => {
                attributeSetter('eyeColour', -1);
              }}
            >
              {'<<'}
            </button>
            ...
            <button
              className="question-submit-btn"
              disabled={eyeColourIndex === alien.eyeColour.length - 1}
              onClick={() => {
                attributeSetter('eyeColour', +1);
              }}
            >
            ...
            <button
              className="question-submit-btn"
              onClick={() => {
                attributeRandomizer('isFriendly');
              }}
            >
              Random
            </button>
            ...
            <button
              className="question-submit-btn"
              disabled={hornsIndex === 0}
              onClick={() => {
                attributeSetter('horns', -1);
              }}
            >
              {'<<'}
            </button>
            ...
            <button
              className="question-submit-btn"
              disabled={hornsIndex === alien.horns.length - 1}
              onClick={() => {
                attributeSetter('horns', +1);
              }}
            >
